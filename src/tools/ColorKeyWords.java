...
public class ColorKeyWords implements DocumentListener {
    private KeyWord keywords;//定义KeyWord对象，用于判断是否是关键词
    private Style keywordStyle;
    private Style normalStyle;
    private ContentChangeListener contentChangeListener;
    String lan;
    public ColorKeyWords(JTextPane text,ContentChangeListener contentChangeListener) {
    ...
    public void insertUpdate(DocumentEvent e)
    {
        ...
        if (!MainWindow.isContentChanged){
